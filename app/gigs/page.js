    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 p-6">
      ...
      <div className="flex justify-center mb-6">
        <input
          ...
          className="w-full max-w-md p-3 rounded-xl border shadow focus:outline-none focus:ring-2 focus:ring-blue-400"
        />
      </div>
      ...
      {filteredGigs.length === 0 && (
        <p className="text-center mt-10 text-gray-500">No gigs found 😢</p>
      )}
    </div>
  );
}